#!/bin/bash
# src/build-php81-openssl4.sh
# Build PHP 8.1.34 with OpenSSL 4.x and create package
...
build_icu68() {
    ...
    echo "[ * ] Building ICU 68 for PHP 8.1 compatibility..."
    rm -rf "$icu_prefix"
...
' "ext/openssl/php_openssl.h"
	...
	# 补丁5: 替换 OpenSSL 源文件
	# ============================================================
	local custom_openssl_dir="$SCRIPT_DIR/php8.1"
...
build_php() {
    ...
    # ============================================================
    # PHP 8.1 特殊处理：使用 ICU 68
    # ============================================================
    if [ "$major" = "8" ] && [ "$minor" = "1" ]; then
        # 编译 ICU 68
        if ! build_icu68; then
...
This is a custom build of PHP 8.1.34 that includes:
...
IMPORTANT: PHP 8.1 is end-of-life. Use at your own risk.
EOD
EOF
...
#!/bin/sh
echo "========================================"
echo "PHP 8.1.34 with OpenSSL 4.x installed"
echo "========================================"
