...
# Build PHP 8.3.30 with OpenSSL 3.x and create package
...
apply_patches() {
    ...
    # ============================================================
    local custom_openssl_dir="$SCRIPT_DIR/php8.3"
    ...
    # ============================================================
    echo "[ * ] Forcing bundled xxHash for PHP ${PHP_VERSION}..."
...
This is a custom build of PHP 8.3.30 that includes:
- OpenSSL 3.x compatibility patches
- FPM, CLI, CGI support
- Common extensions: mbstring, bcmath, curl, gmp, mysqli, pdo_mysql, pgsql, pdo_pgsql, etc.

IMPORTANT: PHP 8.3 is actively supported. This build is for Hestia Control Panel.
EOD
EOF
...
#!/bin/sh
echo "========================================"
echo "PHP 8.3.30 with OpenSSL 3.x installed"
echo "========================================"
...
main() {
    ...
    if build_php; then
        ...
        if create_package; then
            ...
            echo "✅ ALL COMPLETED"
            echo "========================================"
            echo "Package: ${ARTIFACT_DIR}/php83-openssl3-${PHP_VERSION}.pkg"
            echo "========================================"
            exit 0
        else
            echo ""
