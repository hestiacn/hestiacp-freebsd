#!/bin/bash
# src/test-php71-openssl4.sh
# TEST: PHP 7.1.33 with OpenSSL 4.0.1
...
scan_openssl_compatibility() {
    ...
    local used_functions_file="$LOG_DIR/php71-used-functions.txt"
    > "$used_functions_file"
...
main() {
    echo ""
    echo "========================================"
    echo "TEST: PHP 7.1.33 with OpenSSL 4.0.1"
    echo "========================================"
